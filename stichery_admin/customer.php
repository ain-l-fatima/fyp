...
<html lang="en">
  ...
  <div class="navbar-container" style="padding:8px 12px;">
    ...
    <h2  class="text-center" style="padding-top:10rem;"><strong>Customers Detail</strong></h2>   
    <h2>List Of Customers</h2>
    <a class="btn btn-primary"href="/stichery_admin/create.php" role="button" style="margin-bottom: 28px; margin-top: 1rem;">Add New Customer</a>
    <br>
    <table class="table">
        <thead>
            <tr>
