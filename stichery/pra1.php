...
<head>
    ...
    <link rel="stylesheet" href="media.css"> -->
       ...
       <link rel="styleesheet"  href="pra1.css"> 
 ...
 <div class="header">
    <div class="nav_bar-top">
      ...
      ?>
                              ...
                              <li class="nav-item">
                              <a href="mycart.php" class="btn-home">Cart (<?php echo $count?>)</a>
                              </li>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
           <div class="pages-footer">
            <h3 class="heading-pages">Pages Links</h3>
              ...
              <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                  <a class="nav-link footer-links" aria-current="page" href="#">About</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link footer-links" href="#">Categories</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link footer-links "href="#">cataloge</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link footer-links "href="#">Contact Us</a>
                </li>
                <li class="nav-item dropdown">
